...
import { WiredActionSelectorUsersInZoneView } from './WiredActionSelectorUsersInZoneView';
...
export const WiredActionLayoutView = (code: number) =>
{
    switch(code)
    {
        ...
        case WiredActionLayoutCode.SELECTOR_USERS_IN_ZONE:
            return <WiredActionSelectorUsersInZoneView />;
    }
